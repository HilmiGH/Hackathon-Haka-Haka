...
<body style="margin: 0; padding: 0;">
    <div class="dashboard-container">
        <aside class="navbar-side" style="box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.50); position: relative; max-width: 300px">
            <nav class="nav flex-column " style="padding: 20px">
                ...
                {{ Request::is('dashboard') ? 'border-radius: 12px; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%));' : ''}}" aria-current="page" href="#">
        ...
        <div style="width: 100%">
            ...
            <div class="dashboard">
                <div class="d-flex align-items-center" style="margin-bottom: 30px">
                    ...
                    font-style: normal;
                    font-weight: 900;
                    line-height: 72px; /* 150% */ margin-right: 30px; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%));
                    background-clip: text;
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;">Ringkasan Usaha</h1>
                </div>
                <div class="d-flex" style="gap: 30px; margin-bottom: 30px">
                    <div style="background-color: white; padding: 10px; border-radius: 15px; 
                    box-shadow: 0px 1.05455px 2.10909px 0px rgba(0, 0, 0, 0.50);">
                        <h4 style="color: #141414;
                        font-family: Lato;
                        font-size: 18px;
                        font-style: normal;
                        font-weight: 800;
                        line-height: 34px; /* 188.889% */">Total Pendapatan</h4>
                        <h4 style="font-family: Lato;
                        font-size: 36px;
                        font-style: normal;
                        font-weight: 900;
                        line-height: 34px; /* 94.444% */; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%));
                        background-clip: text;
                        -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent;">Rp{{ number_format(\App\Models\Transaksi::sum('total_harga'), 0, ',', '.') }}</h4>
                        @php
                    ...
                    <div style="background-color: white; padding: 10px; border-radius: 15px; box-shadow: 0px 1.05455px 2.10909px 0px rgba(0, 0, 0, 0.50);
                    ">
                        <h4 style="color: #141414;
                        font-family: Lato;
                        font-size: 18px;
                        font-style: normal;
                        font-weight: 800;
                        line-height: 34px; /* 188.889% */">Total Penjualan</h4>
                        <h4 style="font-family: Lato;
                        font-size: 36px;
                        font-style: normal;
                        font-weight: 900;
                        ...
                        background-clip: text;
                        -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent;">{{ \App\Models\DetailKeranjang::sum('jumlah_produk') }} Pcs</h4>
                        <h6 style="color: #1E1E1E;
                        font-family: Lato;
                        font-size: 16px;
                        font-style: normal;
                        font-weight: 700;
                        line-height: 26px; /* 162.5% */">10% kurang dari hari kemarin</h6>
                    </div>
                    <div style="background-color: white; padding: 10px; border-radius: 15px; box-shadow: 0px 1.05455px 2.10909px 0px rgba(0, 0, 0, 0.50);">
                        <h4 style="color: #141414;
                        font-family: Lato;
                        ...
                        font-style: normal;
                        font-weight: 800;
                        line-height: 34px; /* 188.889% */">Total Transaksi</h4>
                        <h4 style="font-family: Lato;
                        font-size: 36px;
                        font-style: normal;
                        font-weight: 900;
                        ...
                        background-clip: text;
                        -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent;">{{ \App\Models\Transaksi::count() }} Transaksi</h4>
                        <h6 style="color: #1E1E1E;
                        font-family: Lato;
                        font-size: 16px;
                        font-style: normal;
                        font-weight: 700;
                        line-height: 26px; /* 162.5% */">20% lebih dari hari kemarin</h6>
                    </div>
                    <div style="background-color: white; padding: 10px; border-radius: 15px; box-shadow: 0px 1.05455px 2.10909px 0px rgba(0, 0, 0, 0.50);">
                        <h4 style="color: #141414;
                        font-family: Lato;
                        ...
                        font-style: normal;
                        font-weight: 800;
                        line-height: 40px; /* 188.889% */">Total Pelanggan</h4>
                        <h4 style="font-family: Lato;
                        font-size: 36px;
                        font-style: normal;
                        font-weight: 900;
                        ...
                        background-clip: text;
                        -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent;">{{ \App\Models\Pelanggan::count() }} Pelanggan</h4>
                        <h6 style="color: #1E1E1E;
                        font-family: Lato;
                        font-size: 16px;
                        font-style: normal;
                ...
                <div class="d-flex" style="gap: 30px; margin-bottom: 30px;
                ">
                    <div class="" style="width: 600px; height: 550px; background-color: white; border-radius: 10px; padding: 20px; box-shadow: 0px 1px 2.11px 0px rgba(0, 0, 0, 0.50);">
                        <h2 style="margin-bottom: 10px"><strong>Chart Pertumbuhan Pendapatan Usaha</strong></h2>
                        <div class="chart-container">
                            <canvas id="myBarChart"></canvas>
                        </div>
                    </div>
                    <div class="" style="width: 450px; height: 550px; background-color: white; border-radius: 10px; margin-bottom: 10px; padding: 20px; box-shadow: 0px 1px 2.11px 0px rgba(0, 0, 0, 0.50);">
                        <h2><strong>Chart Volume Pelanggan</strong></h2>
                        <canvas id="myPieChart"></canvas>
                    </div>
                </div>
                <div class="d-flex" style="gap: 30px; margin-bottom: 30px; ">
                    <div style="max-width: 1000px; width: 800px; background-color: white; padding: 20px; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.25); border-radius: 10.773px;
                    ">
                        ...
                        font-style: normal;
                        font-weight: 900;
                        line-height: 42px; /* 175% */">Transaksi Terkini</h2>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    font-style: normal;
                                    font-weight: 700;
                                    line-height: 42px; /* 210% */; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%));
                                    background-clip: text;
                                    -webkit-background-clip: text;
                                    -webkit-text-fill-color: transparent;">ID order</th>
                                    <th style="font-family: Lato;
                                    font-size: 20px;
                                    font-style: normal;
                                    font-weight: 700;
                                    ...
                                    background-clip: text;
                                    -webkit-background-clip: text;
                                    -webkit-text-fill-color: transparent;">Produk/Layanan</th>
                                    <th style="font-family: Lato;
                                    font-size: 20px;
                                    font-style: normal;
                                    font-weight: 700;
                                    ...
                                    background-clip: text;
                                    -webkit-background-clip: text;
                                    -webkit-text-fill-color: transparent;">Total Harga</th>
                                    <th style="font-family: Lato;
                                    font-size: 20px;
                                    font-style: normal;
                                    font-weight: 700;
                                    ...
                                    background-clip: text;
                                    -webkit-background-clip: text;
                                    -webkit-text-fill-color: transparent;">Tanggal</th>
                                    <th style="font-family: Lato;
                                    font-size: 20px;
                                    font-style: normal;
                                    font-weight: 700;
                                    ...
                                    background-clip: text;
                                    -webkit-background-clip: text;
                                    -webkit-text-fill-color: transparent;">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php
                                ...
                                @foreach($transaksis as $transaksi)
                                    <tr>
                                        ...
                                        font-style: normal;
                                        font-weight: 700;
                                        line-height: 42px; /* 210% */">{{ $transaksi->id }}</td>
                                        <td style="color: #121212;
                                        font-family: Lato;
                                        font-size: 20px;
                                        font-style: normal;
                                        ...
                                        font-style: normal;
                                        font-weight: 700;
                                        line-height: 42px; /* 210% */">Rp {{ number_format($transaksi->total_harga, 0, ',', '.') }}</td>
                                        <td style="color: #121212;
                                        font-family: Lato;
                                        font-size: 20px;
                                        font-style: normal;
                                        ...
                                        font-style: normal;
                                        font-weight: 700;
                                        line-height: 42px; /* 210% */">{{ $transaksi->status_transaksi }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div style="max-width: 1000px ; width: 250px ; background-color: white; padding: 20px; border-radius: 10.773px; box-shadow: 0px 1px 2.11px 0px rgba(0, 0, 0, 0.50);
                    ">
                        <h2 style="color: #141414;
                        font-family: Lato;
                        font-size: 24px;
                        font-style: normal;
                        font-weight: 900;
                        line-height: 42px; /* 175% */">Top Produk</h2>
                        <table class="table table-bordered">
                            <tbody>
                                @php
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            ...
                                            <div style="margin-left: 7.5px">
                                                <p style="margin-bottom: 0px; color: #121212;
                                                font-family: Lato;
                                                font-size: 16px;
                                                font-style: normal;
                                                font-weight: 700;
                                                line-height: 26px; /* 162.5% */">{{ $topProduct->nama_produk }}</p>
                                                <p style="margin-bottom: 0px; color: #696969;
                                                font-family: Lato;
                                                font-size: 12px;
                                                font-style: normal;
                                                font-weight: 700;
                                                line-height: 26px; /* 216.667% */">{{ $topProduct->total_pembelian }} items</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var warnaPelangganLakiLaki = '#000AFF';
            var warnaPelangganPerempuan = '#4DBFFF';
