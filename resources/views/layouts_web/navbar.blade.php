  ...
  <div class="container-fluid z-50">
    ...
    <div class="collapse navbar-collapse justify-content-center pe-5" id="navbarSupportedContent">
      <ul class="navbar-nav nav-underline" style="gap: 30px">
        ...
        <li class="nav-item {{ Request::is('mojuwiki') ? 'active' : '' }}">
          <a class="nav-link" style="{{ Request::is('mojuwiki') ? 'font-family: Lato; font-size: 24px; font-weight: 900; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%)); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;' : 'font-size: 24px;'}}" href="/mojowiki">Mojowiki</a>
        </li>
