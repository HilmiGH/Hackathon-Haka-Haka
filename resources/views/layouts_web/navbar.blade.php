<nav class="navbar nav-underline navbar-expand-lg bg-white sticky-top z-50" style="box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.40);">
  <div class="container-fluid z-50">
    <a class="navbar-brand" style="margin-left: 70px" href="#"><img src="{{ asset('img/LP-Mojoworks-Logo.png') }}" alt=""></a>
    ...
    <button class="btn" style="padding: 10px; padding-inline: 20px; margin-right: 80px; background: var(--gradddd, linear-gradient(147deg, #4DBFFF 19.92%, #000AFF 107.06%));">
